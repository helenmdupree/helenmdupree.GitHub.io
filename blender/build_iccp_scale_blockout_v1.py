...
OUT_BLEND=r"C:\GitHub\soubel-iccp-interactive\blender\iccp_scale_blockout_v1.blend"
OUT_RENDER=r"C:\GitHub\soubel-iccp-interactive\blender\iccp_scale_blockout_v1.png"
...
tube('AC Drop',[(-6.3,0,6.5),(-6.05,0,3.15),(rx,0,2.60)],.025,black)
# test station
...
# leads
tube('Positive Lead',[(rx,0,2.0),(rx,0,.18),(5.8,0,.18)],.035,red); tube('Negative Lead',[(rx+.12,0,2.0),(rx+.12,0,-.25),(rx+.5,0,CZ),(-4.6,0,CZ)],.035,blue)
# anodes
...
# labels
txt('1.70 m person',(hx,.26,1.95),.25,white); txt('30 in / 0.762 m OD',(0,.26,CZ-.75),.27,white); txt('36 in / 0.914 m cover',(1.6,.26,-.45),.25,cyan); txt('Rectifier cabinet ~17.5 x 15.5 x 23.5 in',(rx,.28,3.0),.23,white); txt('TRUE-SCALE BLOCKOUT | CONCEPTUAL - NOT FOR DESIGN',(0,.28,3.25),.30,cyan)
