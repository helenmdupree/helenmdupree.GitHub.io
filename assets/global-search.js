...
`;
    ...
    function loadIndex(){
      ...
      indexPromise=new Promise((resolve,reject)=>{
        ...
        s.src='/assets/library-search-index-v2.js?v=2';
    ...
    function scoreItem(item,query){
      ...
      const searchable=title+' '+desc+' '+body;
      if(tokens.length>1 && !tokens.every(t=>hasTerm(searchable,t))) return 0;
      let score=0;
      ...
      if(tokens.every(t=>hasTerm(searchable,t))) score+=12;
      return score;
    }
